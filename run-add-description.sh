...
echo -e "${BOLD}==========================================${NC}"
echo -e "${BOLD}${GREEN}Add Idea Title and Description Test${NC}"
echo -e "${BOLD}==========================================${NC}"
...
echo "  4. Fill in the title field with chunked typing approach"
echo "  5. Fill in the description field with chunked typing approach"
echo ""
