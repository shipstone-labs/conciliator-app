...
export default function MCPTestPage() {
  const [response, setResponse] = useState<string>('Click a button to test an MCP method')
          ...
          <CardContent className="pt-6 space-y-5">
            <div className="space-y-4">
              <p className="text-white/90 leading-relaxed">
                Test the Multi-Context Protocol (MCP) API endpoints. Click the buttons below to test various methods:
              </p>
              ...
              <div className="mt-6">
                <h3 className="text-sm font-medium text-white/70 mb-2">Response:</h3>
