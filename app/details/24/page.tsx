...
export default function EnhancedDetailPage() {
  ...
  const ideaData = {
    ...
    tags: ["Smart Home", "Energy Efficiency", "AI", "IoT", "Sustainability", "Machine Learning"],
    keyFeatures: [
    ...
    <div className="min-h-screen bg-background p-6 bg-gradient-to-b from-[hsl(var(--gradient-start))] to-[hsl(var(--gradient-end))]">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">Review idea information and access options</p>
        </div>
        ...
        <Card className="w-full backdrop-blur-lg bg-background/30 border border-white/10 shadow-xl overflow-hidden">
          ...
          <CardContent className="pt-6 space-y-5">
            <div>
              <h3 className="text-sm font-medium text-white/50 mb-2">Public Description</h3>
          ...
          <CardContent className="pt-4">
            ...
            <div className="space-y-3">
              <div className="flex flex-col space-y-2">
                <h3 className="text-sm font-medium text-white/70">Available Evaluation Periods:</h3>
                <div className="grid grid-cols-3 gap-3">
                  {ideaData.pricingOptions.map((option, index) => (
                    <div key={index} className="p-3 border border-white/10 rounded-xl bg-muted/20 flex justify-between items-center">
        ...
        <Card className="w-full backdrop-blur-lg bg-background/30 border border-white/10 shadow-xl overflow-hidden">
          ...
          <CardContent className="pt-4 space-y-6">
            ...
            <div className="space-y-2">
              ...
              {isCreator && (
                <button className="text-xs text-primary/70 hover:text-primary mt-1 flex items-center gap-1">
            ...
            {/* Key Features */}
            <div className="space-y-2">
              <h3 className="text-sm font-medium text-white/70">Key Features:</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-medium text-white/70">Additional Information:</h3>
        ...
        <Card className="w-full backdrop-blur-lg bg-background/30 border border-white/10 shadow-xl overflow-hidden">
          ...
          <CardContent className="pt-4 space-y-4">
            <p className="text-white/90 text-sm leading-relaxed">
              Access to this idea requires a signed Non-Disclosure Agreement (NDA).
            </p>
            ...
            <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-4">
                  <div className="p-3 border border-primary/30 rounded-xl bg-primary/10 flex items-center gap-3">
                    ...
                    <div className="flex-grow">
                      <p className="text-white/90 text-sm font-medium">Signed NDA Received</p>
                      <p className="text-white/70 text-xs">From: potential_buyer@example.com - 12 hours ago</p>
                    </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" className="flex items-center gap-2 text-red-400 border-red-400/30 hover:bg-red-500/10">
                      Reject
                    </Button>
                  </div>
                </div>
              ...
              {isCreator && ideaData.ndaStatus === 'approved' && (
                <div className="p-3 border border-green-500/30 rounded-xl bg-green-500/10 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/90 text-sm font-medium">NDA Approved</p>
                    <p className="text-white/70 text-xs">Access granted to potential_buyer@example.com</p>
                  </div>
                </div>
              )}
            </div>
