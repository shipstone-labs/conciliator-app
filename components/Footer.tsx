    ...
    <>
      ...
      >
        <div className="space-y-5 text-foreground/90">
          ...
          <p>
            By accessing or using SafeIdea services, you agree to be bound by
          ...
          <p>
            ...
            SafeIdea&apos;s website for personal, non-commercial transitory
          ...
          <p>
            The materials on SafeIdea&apos;s website are provided on an &apos;as
            is&apos; basis. SafeIdea makes no warranties, expressed or implied,
          ...
          <p>
            In no event shall SafeIdea or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on SafeIdea&apos;s website, even if
            SafeIdea or a SafeIdea authorized representative has been notified
      ...
      >
        <div className="space-y-5 text-foreground/90">
          ...
          <p>
            ...
            services, such as when you create an account, update your profile,
            use the interactive features of our services, participate in
            contests, promotions, or surveys, request customer support, or
          ...
          <p>
            ...
            by logging into your online account and modifying your information
            or by emailing us. If you wish to delete or deactivate your account,
            please email us, but note that we may retain certain information as
