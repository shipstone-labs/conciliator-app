...
const DetailIP = ({
  ...
  const ideaData = {
    ...
    description: "A sophisticated AI system that generates high-quality content tailored to specific industries and audiences. The system leverages cutting-edge machine learning models to understand context, brand voice, and audience preferences to create engaging articles, social media posts, and marketing materials that resonate with target demographics.",
    ...
    <div className="min-h-screen bg-background p-6 bg-gradient-to-b from-[hsl(var(--gradient-start))] to-[hsl(var(--gradient-end))]">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">Review your idea information and proceed to discovery</p>
        </div>
        ...
        <Card className="w-full backdrop-blur-lg bg-background/30 border border-white/10 shadow-xl overflow-hidden">
          ...
          <CardContent className="pt-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              <div>
                <h3 className="text-sm font-medium text-white/50 mb-1">Created On</h3>
                <p className="text-white/90">{ideaData.createdAt}</p>
              </div>
              <div>
