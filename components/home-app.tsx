      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-6 py-16">
        ...
        <div className="max-w-3xl mx-auto text-center backdrop-blur-lg bg-background/30 p-8 rounded-2xl shadow-xl border border-white/10 mt-8">
          <p className="text-lg leading-relaxed text-white/90">
            ...
            This is the alpha version of our IP protection platform. We help
            creators and inventors store, share, and monetize their ideas
            securely.
          </p>
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/90">
            ...
            creators ready to protect their intellectual property in the digital
            age.
          </p>
        </div>
