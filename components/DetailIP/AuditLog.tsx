  ...
  return audit ? (
    <Card className="w-full backdrop-blur-lg bg-background/30 border border-border/30 shadow-xl overflow-hidden">
      ...
      <CardContent className="pt-6 space-y-5">
        ...
        >
          <div className="text-foreground font-bold text-sm">Created On</div>
          <div className="text-foreground/80 text-sm">
            {formatDate(audit.createdAt)}
          </div>
          <div className="text-foreground font-bold text-sm">Status</div>
          <div className="text-foreground/80 text-sm">{audit.status}</div>
          <div className="text-foreground font-bold text-sm">Creator</div>
          <div className="text-foreground/80 text-sm">
            id={audit.creator}
            <br />
            address={audit.address}
          </div>
          <div className="text-foreground font-bold text-sm">Token ID</div>
          <div className="text-foreground/80 text-sm">
        ...
        {audit.details?.map((detail) => (
          ...
          >
            ...
            <div className="text-foreground font-bold text-sm">Status</div>
            <div className="text-foreground/80 text-sm">{detail.status}</div>
          </div>
        )) || null}
      </CardContent>
    </Card>
